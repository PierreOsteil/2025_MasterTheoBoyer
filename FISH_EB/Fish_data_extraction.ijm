...
run("Select All");
roiManager("Measure");
saveAs("Results", "C:/Users/piosteil/Desktop/Work/4-All_git/FISH_EB/data/"+imgName+"_C3.txt");
...
run("Select All");
roiManager("Measure");
saveAs("Results", "C:/Users/piosteil/Desktop/Work/4-All_git/FISH_EB/data/"+imgName+"_C2.txt");

// GATA6 Channel (Channel 1)
selectImage("C1-"+imgName);
run("Subtract Background...", "rolling=10 stack");
setThreshold(400, 65535, "raw"); // treshshold at 400 for GATA6
run("Convert to Mask", "background=Dark create");
run("Analyze Particles...", "size=10 pixel clear add stack");
run("Select All");
roiManager("Measure");
saveAs("Results", "C:/Users/piosteil/Desktop/Work/4-All_git/FISH_EB/data/"+imgName+"_C1.txt");